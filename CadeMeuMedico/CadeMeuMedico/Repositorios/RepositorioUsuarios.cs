...
namespace CadeMeuMedico.Repositorios
{
    public class RepositorioUsuarios
    {
        ...
        {
            var SenhaCriptografada = FormsAuthentication.HashPasswordForStoringInConfigFile(Senha, "40BD001563085FC35165329EA1FF5C5ECBDBBEEF");
            try
            {
        ...
        public static Usuarios VerificaSeOUsuarioEstaLogado()
        {
            ...
            {                
                long iDUsuario = Convert.ToInt64(RepositorioCriptografia.Descriptografar(1.ToString()));
